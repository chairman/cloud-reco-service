...
public class Lte implements Selector {
    private String key;
    private Object value;

    private Lte(String key, Object value){
        this.key = key;
        this.value = value;
    }
    ...
    private Lte(Selector[] selectors){
    ...
    static {
        Registry.addSelector(new Builder<Selector>() {
            ...
            public Selector build(JsonNode params) {
                ...
                return new Lte(nodes.get(0).asText(),toObject(nodes.get(1)));
            }
