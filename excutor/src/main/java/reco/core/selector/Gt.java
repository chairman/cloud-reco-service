...
public class Gt implements Selector {
    private String key;
    private Object value;

    private Gt(String key, Object value){
        this.key = key;
        this.value = value;
    }
    ...
    static {
        Registry.addSelector(new Builder<Selector>() {
            ...
            public Selector build(JsonNode params) {
                ...
                return new Gt(nodes.get(0).asText(),toObject(nodes.get(1)));
            }
