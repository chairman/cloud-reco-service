...
public class Gte implements Selector {
    private String key;
    private Object value;

    private Gte(String key, Object value){
        this.key = key;
        this.value = value;
    }
    ...
    private Gte(Selector[] selectors){
    ...
    static {
        Registry.addSelector(new Builder<Selector>() {
            ...
            public Selector build(JsonNode params) {
                ...
                return new Gte(nodes.get(0).asText(),toObject(nodes.get(1)));
            }
